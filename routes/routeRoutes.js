...
const { uploadRoutes, getRouteByUser, addRoutePlanFromSelectedRoutes, requestRoutePlan, getRequestedRoute, getRequestedRouteForAdmin, approveRequestedRoute, rejectRequestedRouteByAdmin, deleteRequestedRoute } = require("../controllers/common/routeController");
...
router.delete("/delete-requested-route-for-user/:routeId", userAuth, deleteRequestedRoute);
